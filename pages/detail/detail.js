...
var article = `< !DOCTYPE HTML ><!--注释: wxParse试验文本-->
      <div style="text-align:center;margin-top:10px;">
		<img src="https://weappdev.com/uploads/default/original/1X/84512e0f4591bcf0dee42c3293f826e0c24b560c.jpg" alt="富文本解析组件Logo">
		<h1 style="color:red;">富文本解析</h1>
	...
	<div style="margin-top:10px;">
		<h3 style="color: #000;">内联样式style</h3>
...
Page({
  ...
  onLoad: function (e) {
    ...
    wx.request({
      ...
      data:{
        // pagename: "#!/ bid / 177502 / ct / read"
        // pagename: "#!/ bid /" + e.bid +" / ct / read"
      },
      success: function (e){
        console.log("请求成功", e.data)
        that.setData({
          // html: e.data.substring(e.data.indexOf("<html"), e.data.indexOf("</html>"))
          html: WxParse.wxParse('html', 'html', article, that, 5)
        });
      }
    })
  },
